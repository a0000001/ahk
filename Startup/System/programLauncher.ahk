...
; ^!d::
	; if(borgWhichMachine = THINKPAD) {
		; activateOpenMinimize(pLaunchClass_Chat, pLaunchPath_Chat)
	; } else {
		; Send, %A_ThisHotkey%
	; }
; return
...
#3::activateOpenMinimize(pLaunchClass_3, pLaunchPath_3)
#4::activateOpenMinimize(pLaunchClass_4, pLaunchPath_4)
#5::activateOpenMinimize(pLaunchClass_5, pLaunchPath_5)